...
export class KeyboardService {
  ...
  private toCode(code: number): number {
    ...
    switch (code) {
      ...
      // I changed the space bar to work the same as the arrow key
      // If the space bar is needed change "UP" to "SPACE"
      case 32: idx = KeyCodes.UP; break;
      case 87: idx = KeyCodes.UP; break;
      case 83: idx = KeyCodes.DOWN; break;
      case 65: idx = KeyCodes.LEFT; break;
      case 68: idx = KeyCodes.RIGHT; break;
      default: idx = -1; break;
    }
    return idx;
  }
